...
function ManifestPlugin(opts) {
  this.opts = _.assign({
    basePath: '',
    publicPath: '',
    useBasePathAndPublicPath: false,
...
ManifestPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin('emit', function(compilation, compileCallback) {
    ...
    if (this.opts.useBasePathAndPublicPath) {
      // only if useBasePathAndPublicPath is set, always use both basePath and publicPath are used
