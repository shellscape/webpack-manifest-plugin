...
ManifestPlugin.prototype.apply = function(compiler) {
  ...
  var emit = function(compilation, compileCallback) {
    ...
    if (isLastEmit) {
      compiler.hooks.webpackManifestPluginBeforeEmit.callAsync(manifest, (err, manifest) => {
  ...
  if (compiler.hooks) {
    ...
    compiler.hooks.webpackManifestPluginBeforeEmit = new AsyncSeriesWaterfallHook(['manifest']);
