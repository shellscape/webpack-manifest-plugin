...
ManifestPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin('emit', function(compilation, compileCallback) {
    ...
    _.merge(manifest, compilation.chunks.filter(function(chunk) {
      return this.opts.chunks === null || this.opts.chunks.indexOf(chunk.name) >= 0;
    }.bind(this)).reduce(function(memo, chunk) {
