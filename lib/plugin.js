...
ManifestPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin('emit', function(compilation, compileCallback) {
    ...
    Object.assign(manifest, compilation.chunks.reduce(function(memo, chunk) {
    ...
    Object.assign(manifest, stats.assets.reduce(function(memo, asset) {
    ...
    if (this.opts.basePath) {
      manifest = Object.keys(manifest).reduce(function(memo, key) {
        memo[resolvePath(this.opts.basePath, key)] = resolvePath(this.opts.basePath, manifest[key]);
        return memo;
      }.bind(this), {});
      ...
      manifest = Object.keys(manifest).reduce(function(memo, key) {
        memo[key] = resolvePath(this.opts.publicPath, manifest[key]);
        return memo;
      }.bind(this), {});
    }
