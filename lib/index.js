...
class WebpackManifestPlugin {
  ...
  apply(compiler) {
    ...
    const emit = function emit(compilation, compileCallback) {
      ...
      const publicPath =
        this.opts.publicPath != null ? this.opts.publicPath : compilation.options.output.publicPath;
    ...
    if (compiler.hooks) {
      ...
      if (!Object.isFrozen(compiler.hooks)) {
        compiler.hooks.webpackManifestPluginAfterEmit = getCompilerHooks(compiler).afterEmit;
      }
